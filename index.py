...
path_blood_det_py = "./Danzas-Recongnition/"
sys.path.append(path_blood_det_py)
from blood_detection import detection

#template_dir = os.path.abspath('./Danzas-Recongnition/web/')
#app = Flask(__name__, template_folder=template_dir)
app = Flask(__name__)

UPLOAD_FOLDER = os.path.abspath("Danzas-Recongnition/web/static/inference/input")
OUTPUT_FOLDER = os.path.abspath("Danzas-Recongnition/web/static/inference/output")
